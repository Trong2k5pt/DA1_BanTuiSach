...
namespace DA_1BanTuiSach
{
    public partial class KhuyenMai : Form
    {
        ...
        {
            string query = "UPDATE KhuyenMai SET tenKhuyenMai = @tenKhuyenMai, ngayBatDau = @ngayBatDau, ngayKetThuc = @ngayKetThuc, mucGiamGiaToiDa = @mucGiamGiaToiDa, mucGiamGia = @mucGiamGia, trangThai = @trangThai WHERE maKhuyenMai = @maKhuyenMai";
            ...
            using (SqlCommand command = new SqlCommand(query, connection))
            {
                ...
                command.Parameters.AddWithValue("@mucGiamGiaToiDa", txtMucGiamGiaToiDa.Text);
		...
		private void dgvKhuyenMai_CellContentClick(object sender, DataGridViewCellEventArgs e)
		{
            if (e.RowIndex >= 0)
            {
                ...
                txtMucGiamGiaToiDa.Text = row.Cells["mucGiamGiaToiDa"].Value.ToString();
        ...
        private void btnThem_Click_1(object sender, EventArgs e)
		{
            ...
            if (string.IsNullOrWhiteSpace(txtMucGiamGiaToiDa.Text) ||
            ...
            string query = "INSERT INTO KhuyenMai (tenKhuyenMai, ngayBatDau, ngayKetThuc, mucGiamGiaToiDa , mucGiamGia, trangThai) " +
                           "VALUES (@tenKhuyenMai, @ngayBatDau, @ngayKetThuc, @mucGiamGiaToiDa, @mucGiamGia, @trangThai)";
        ...
        private void txtTimKiem_TextChanged(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * FROM KhuyenMai WHERE " +
                           ...
                           "mucGiamGiaToiDa LIKE @keyword OR " +
